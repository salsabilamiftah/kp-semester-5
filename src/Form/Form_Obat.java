...
public class Form_Obat extends javax.swing.JFrame {
    ...
    public void Simpan(){
        ...
        String tgl = String.valueOf(format.format(kadaluarsa.getDate()));
    ...
    public void Update(){
        ...
        String idkategori = txtidkategori.getText();
        String kategori = txtkategoriobat.getText();
        String tgl = (format.format(kadaluarsa.getDate()));
        String harga = txtharga.getText();
        try{
            Statement state  = koneksinya.Koneksi().createStatement();
    ...
    private void initComponents() {
        ...
        kadaluarsa = new com.toedter.calendar.JDateChooser();
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbcari, 0, 313, Short.MAX_VALUE)
    ...
    private void tabelobatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelobatMouseClicked
        ...
        if(evt.getClickCount()==1){
            Tabelklik();
            kadaluarsa.setDate(AmbilTanggal(tabelobat, 5));
        }
    ...
    private com.toedter.calendar.JDateChooser kadaluarsa;
